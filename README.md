        ...
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 mb-10 md:mb-0">
            ...
            <p class="text-lg md:text-xl opacity-90 mb-8 max-w-lg">
              从幼儿启蒙到专业英语考试全覆盖，通过7种科学记忆法适配不同年龄层的学习需求。
            </p>
          ...
          <div class="md:w-1/2 flex justify-center">
            <img src="https://picsum.photos/seed/wordmaster/600/400" alt="儿童学习英语单词" class="rounded-lg shadow-2xl animate-float">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="bg-white rounded-xl overflow-hidden shadow-md card-hover lg:col-span-3">
            <img src="https://picsum.photos/seed/ai/800/400" alt="AI视频互动记忆法" class="w-full h-64 object-cover">
            <div class="p-6">
              <div class="flex items-center mb-4">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div class="rounded-xl overflow-hidden shadow-lg">
            <img src="https://picsum.photos/seed/team/600/400" alt="我们的团队" class="w-full h-auto">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">单词列表</a></li>
